...
const TOPIC_ID = "japanese-basic-vocab";
...
// Ignore spacing/punctuation differences and tolerate a single-character
// typo on longer answers.
...
function handleAnswer(answer) {
  ...
  if (q.note) {
    el.noteHint.textContent = `${q.kana}  →  ${q.note}`;
