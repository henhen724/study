...
const TOPIC_ID = "latin-inscriptions";
...
// Ignore spacing/punctuation differences ("the senate and people of rome"
// vs "the Senate and People of Rome") and tolerate a single-character typo
// on longer answers.
...
function handleAnswer(answer) {
  ...
  if (q.note) {
    el.noteHint.textContent = `${q.latin}  →  ${q.note}`;
